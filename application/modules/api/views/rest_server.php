...
<head>
     <meta charset="utf-8">
     <title>Rest Server Repository</title>
...
<body>
     ...
     <div id="container">
          <h1>REST Server Tugas Akhir (Repository & Evaluasi)</h1>
          ...
          <div id="body">
               ...
               <ol>
                    <li><a href="<?php echo site_url('api/rest_users/users'); ?>">Rest Users</a> - Akses Rest Users</li>
                    <li><a href="<?php echo site_url('api/rest_manajerial/manajerial'); ?>">Rest Manajerial</a> - Akses
                         Rest Manajerial</li>
                    <!-- <li><a href="<?php echo site_url('api/rest_kuesioner/kuesioner'); ?>">Rest Kuesioner</a> - Akses
                         Rest Kuesioner</li> -->
                    <li><a href="<?php echo site_url('api/rest_jawaban/jawaban'); ?>">Rest Jawaban</a> - Akses Rest
                         Jawaban</li>
               </ol>
